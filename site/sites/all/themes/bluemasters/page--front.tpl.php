    ...
    <div id="wrapper">
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <div class="slider-item-caption">Domaine les Portes du Mont Blanc</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <div class="slider-item-caption">Appartement de 35m2, jusqu'&agrave 8 personnes</div>
                </li>
                <!-- EOF: slider-item -->
                ...
                <div class="slider-item-caption">Au coeur des Aravis, entre La Clusaz et Meg&egrave;ve</div>
                </li>
                <!-- EOF: slider-item -->
